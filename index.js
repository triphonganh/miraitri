...
axios.get('https://hely-t.github.io/miraivuotgban-1.2.15/package.json').then((res) => {
    const _0x3a9e=['1AXwrul','Kanichi ]','update" to','lable, sta',' update!','/cmd and t','ype "node ','rt update ','862159qoBWCB','You are us','lable! Ope','n terminal','update.js','A new upda','ing the la','autoUpdate','958778LHuBmX','on!','83620gADsGo','./package.','stdio','[ K-','processing','191jFgcNd','te is avai','cwd','18537oEWTvD','12247HXxipe','Unable to ','parse','version','1543102iuYYuT','inherit','node','test versi','exit','274241cWRKsD'];
